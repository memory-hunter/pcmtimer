...
namespace printer
{
    inline void print_difference(const SystemCounterState &before, const SystemCounterState &after)
    {
    ...
    inline void log_stdout(int i, int n, time_unit duration, const SystemCounterState &before, const SystemCounterState &after)
    {
    ...
    template <typename time_unit>
    inline void log_file(int n, time_unit duration, const SystemCounterState &before, const SystemCounterState &after,
                  std::fstream &file)
    {
